...
- Compute:
    - Emoji distribution per language
    - Word-length distribution per language
...
Instead, all trained EA-mLaBSE model checkpoints are publicly available on Hugging Face and can be accessed at: https://huggingface.co/armyjust/EA-mLaBSE
